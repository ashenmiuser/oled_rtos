...
void OLED_GPIO_Init(void)
{
	...
	gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;        /* 鎺ㄦ尳杈撳嚭 */
	gpio_init_struct.Pull = GPIO_PULLUP;                /* 涓婃媺 */
	gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;      /* 楂橀�?*/
	HAL_GPIO_Init(GPIOB, &gpio_init_struct);/* SCL */

	gpio_init_struct.Pin = GPIO_PIN_14;
	gpio_init_struct.Mode = GPIO_MODE_OUTPUT_OD;        /* 寮�婕忚緭鍑?*/
...
/*********************功能函数*/
void oled_showjiemian(void)
{
    OLED_ShowString(20,0,"RUNNING",OLED_8X16);
    OLED_ShowNum(30,20,2000 + Date.Year,4,OLED_6X8);	OLED_DrawPoint (55,26);
    OLED_ShowNum(57,20,Date.Month,2,OLED_6X8);			  OLED_DrawPoint (70,26);
    OLED_ShowNum(72,20,Date.Date,2,OLED_6X8);
    OLED_ShowNum(34,30,sTime.Hours,2,OLED_6X8);	      OLED_DrawPoint (47,32);   OLED_DrawPoint (47,35);
    OLED_ShowNum(48,30,sTime.Minutes,2,OLED_6X8);			OLED_DrawPoint (61,32);   OLED_DrawPoint (61,35);
    OLED_ShowNum(62,30,sTime.Seconds,2,OLED_6X8);
}
/*****************江协科技|版权所有****************/
/*****************jiangxiekeji.com*****************/
